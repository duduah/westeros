...
""")
        _ = Episode(title: "The North Remembers",
                                      releaseDate: Date.getDateFor(date: .yyyyMd(year: 2012, month: 4, day: 1)),
                                      director: ["Alan Taylor"],
                                      scriptWriter: ["David Benioff", "D. B. Weiss"],
                                      plot: "asdf",
                                      season: season2)
        _ = Episode(title: "Nightlands",
        ...
        let season5 = Season(seasonName: "Season 5",
                             ...
                             plot: "Plot season 5")
        _ = Episode(title: "The Wars to Come",
                                      releaseDate: Date.getDateFor(date: .yyyyMd(year: 2015, month: 4, day: 12)),
                                      director: ["Michael Slovis"],
                                      scriptWriter: ["David Benioff", "D. B. Weiss"],
                                      plot: "asdf",
                                      season: season5)
        _ = Episode(title: "The House of Black and White",
